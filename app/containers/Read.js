...
export default class extends Component {
          ...
          this.props.dispatch(
            createAction("book/getChapters")({
              ...
              callback: chapterList => {
                ...
                if (isInit) {
                  // 初始滚动距离
                  Storage.get(`scrollTop_${this.bookId}`, { top: 0 }).then(ret => {
                    this.contentScrollTo(ret.top);
                  });
                }
              }
            })
  ...
  contentScrollTo = (pointY = 0, animated = false) => {
    this._scrollView && this._scrollView.scrollTo({ x: 0, y: pointY, animated });
  };

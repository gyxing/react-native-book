      ...
      <View style={styles.container}>
        ...
        >
          ...
          >
            ...
            />
            <Text style={{ fontSize: 24, color: '#333', marginLeft: 15 }}>
              在线小说阅读
            </Text>
          </View>
        </ImageBackground>
        <View>
          <Text style={{ color: '#666', paddingVertical: 8, paddingLeft: 20 }}>
            设置
          </Text>
          <IButton
            label="清除书架"
            brief="书架列表、已缓存的章节内容等数据"
